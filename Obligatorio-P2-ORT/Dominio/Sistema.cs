...
namespace Dominio
{
    public class Sistema
    {
        ...
        public List<Pasaje> BuscarPasajesPorCliente(string mail)
        {
            ...
            pasajes.Sort(new PasajesPorPrecio());
            return pasajes;
        }
        ...
        public List<Pasaje> PasajesEntreFechas(DateTime fechaUno, DateTime fechaDos)
        {
            List<Pasaje> pasajesOrdenados = new List<Pasaje>();
